...
urlpatterns = [
    ...
    # View only admin and permitted staff
    path('dashboard/users/', views.all_user_list_view, name='all_user_list'),
    path('dashboard/users/activity/', views.user_activity_list, name='user_activity_list'),
    path('dashboard/users/access-logs/', views.user_access_log_list, name='user_access_log_list'),
    path('dashboard/users/<int:user_id>/', views.user_detail_view, name='user_detail'),
    path('dashboard/users/<int:user_id>/status/', views.toggle_user_status, name='toggle_user_status'),
